class ZCL_ZJTOGW_ORDEM_DE_VE_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZFL_ATUALIZA_STATUS,
        ID_STATUS type C length 1,
        ID_ORDEMID type I,
    end of TS_ZFL_ATUALIZA_STATUS .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZJTOGW_ORDEM_DE_VE_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZJTOGW_ORDEM_DE_VE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZJTOGW_ORDEM_DE_VENDA_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJTOGW_ORDEM_DE_VE_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJTOGW_ORDEM_DE_VE_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJTOGW_ORDEM_DE_VE_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250127103550'.                  "#EC NOTEXT
...
***********************************************************************************************************************************
*   ACTION - ZFL_ATUALIZA_STATUS
***********************************************************************************************************************************

lo_action = model->create_action( 'ZFL_ATUALIZA_STATUS' ).  "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZJTOGW_ORDEM_DE_VE_MPC=>TS_ZFL_ATUALIZA_STATUS' ). "#EC NOTEXT
  endmethod.
ENDCLASS.
